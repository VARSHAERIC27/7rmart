...
public class ManageFooterTextTest extends Base {
	...
	public void verifyTheUserIsAbleToUpdateFooterText() throws IOException  {
	  ...
	  news=footer.clickOnActionField().clearTheAddressField().enterAddressOnAddressField(address).clearTheEmailField().enterEmailOnEmailField(email).clearThePhoneField().enterPhoneOnPhoneField(phone).clickOnUpdateField();
